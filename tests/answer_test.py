...
def test_answer_post():
    ...
    resp = client.post('/answer', headers=headers, payload=data)
    print(resp.json)
...
def test_answer_delete_unsuccessful():
    token = None  # TODO: - Test with user
...
def test_answer_delete_successful():
    token = None  # TODO: - Test with user
    headers = {'Authorization': f'Bearer {token}'}
    resp = client.delete('/answer/1')
    print(resp.json)
